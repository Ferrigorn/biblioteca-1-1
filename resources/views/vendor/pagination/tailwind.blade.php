@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}"
        ...
        <!-- Afegim la informació dels resultats primer -->
        <div class="px-5 mb-3"> <!-- Afegim un marge inferior per separar-ho dels botons de paginació -->
            <p class="text-lg text-white-700 leading-5 dark:text-white">
                {!! __('Mostrant del') !!}
        ...
        <!-- Part del codi per als enllaços de la paginació -->
        <div
            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    {{-- Enllaç per a la pàgina anterior --}}
                    ...
                    {{-- Enllaç per a la pàgina següent --}}
