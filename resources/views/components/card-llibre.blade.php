<div class="mb-6 p-4 w-11/12 h-60 bg-cover bg-center flex flex-row justify-between rounded-xl opacity-90 shadow-white shadow-lg hover:scale-125 transition duration-200"
